...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("setCore", &CyPlot::setCore, "void (int iCivilization, bool bNewValue)")
		.def("getSettlerValue", &CyPlot::getSettlerValue, "int (int iCivilization)")
		.def("getPlayerSettlerValue", &CyPlot::getPlayerSettlerValue, "int (int iPlayer)")
		.def("setSettlerValue", &CyPlot::setSettlerValue, "void (int iCivilization, int iNewValue)")
		.def("getWarValue", &CyPlot::getWarValue, "int (int iCivilization)")
		.def("getPlayerWarValue", &CyPlot::getPlayerWarValue, "int (int iPlayer)")
		.def("setWarValue", &CyPlot::setWarValue, "void (int iCivilization, int iNewValue)")
		.def("getSpreadFactor", &CyPlot::getSpreadFactor, "int (int eReligion)")
		.def("setSpreadFactor", &CyPlot::setSpreadFactor, "void (int eReligion, iNewValue)")
		...
		.def("getCultureConversionCivilization", &CyPlot::getCultureConversionCivilization, "int ()")
