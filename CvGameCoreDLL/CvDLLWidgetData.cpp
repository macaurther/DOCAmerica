...
// BUG - Building Actual Effects - end
			...
			else if (GC.getActionInfo(widgetDataStruct.m_iData1).getMissionType() == MISSION_NATIVE_INDOCTRINATION) //FoB
			{
				szBuffer.append(NEWLINE);
				szBuffer.append(gDLL->getText("TXT_KEY_ACTION_INDOCTRINATE_NATIVES"));
			}
