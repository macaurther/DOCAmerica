...
// BUG - Leaderhead Relations - end
	...
	python::enum_<CommerceTypes>("CommerceTypes")
		...
		.value("COMMERCE_IMMIGRATION", COMMERCE_IMMIGRATION)
...
// BUG - Global Warming Mod - end
	...
	python::enum_<FontSymbols>("FontSymbols")
		...
		.value("IMMIGRANT_CHAR", IMMIGRANT_CHAR)
		.value("RANGED_STRENGTH_CHAR", RANGED_STRENGTH_CHAR)
		.value("RANGE_CHAR", RANGE_CHAR)
	...
	python::enum_<UnitAITypes>("UnitAITypes")
		...
		.value("UNITAI_STATESMAN", UNITAI_STATESMAN)
		.value("UNITAI_PERSECUTOR", UNITAI_PERSECUTOR)
		.value("UNITAI_SATELLITE", UNITAI_SATELLITE)
		.value("UNITAI_IMMIGRANT", UNITAI_IMMIGRANT)
		.value("UNITAI_SLAVE", UNITAI_SLAVE)
		.value("UNITAI_SIT_FOREVER", UNITAI_SIT_FOREVER)
		.value("UNITAI_FERRY_IMMIGRANTS", UNITAI_FERRY_IMMIGRANTS)
...
// BUG - Sentry Actions - end
	...
	python::enum_<ControlTypes>("ControlTypes")
		...
		.value("CONTROL_IMMIGRATION_MANAGER", CONTROL_IMMIGRATION_MANAGER) // MacAurther
