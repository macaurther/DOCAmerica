...
enum CivicTypes						// Exposed to Python
{
	...
	CIVIC_DECENTRALIZATION_NATIVE,
	CIVIC_CLANS_NATIVE,
	CIVIC_CITY_STATES_NATIVE,
	CIVIC_TRIBAL_CONFEDERACY_NATIVE,
