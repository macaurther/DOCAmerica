...
minor_cities = [
	MinorCity(-450, iNative, (19, 60), "Palenque", iPopulation=2, iCiv=iMaya, units={iMilitia: 2}, iCulture=5, adjective="TXT_KEY_ADJECTIVE_MAYAN"),			# Maya (Founded 432 BCE) - moved up founding for gameplay
	MinorCity(-400, iNative, (22, 56), "Copan", iPopulation=2, iCiv=iMaya, units={iMilitia: 3}, iCulture=5, adjective="TXT_KEY_ADJECTIVE_MAYAN"),				# Maya (Founded 410 CE) - moved up founding for gameplay
	MinorCity(-250, iNative, (24, 62), "Chichen Itza", iPopulation=2, iCiv=iMaya, units={iMilitia: 4}, iCulture=5, adjective="TXT_KEY_ADJECTIVE_MAYAN"),		# Maya (Founded 600 CE) - moved up founding for gameplay
	MinorCity(450, iNative, (22, 28), "Nazca", iPopulation=1, iCiv=iTiwanaku, units={iMilitia: 2}, iCulture=5, adjective="TXT_KEY_ADJECTIVE_NAZCAN"),			# Nazca
	MinorCity(950, iNative, (16, 15), "Mapuches", iPopulation=1, iCiv=iInca, units={iMilitia: 2}, iCulture=5, adjective="TXT_KEY_ADJECTIVE_MAPUCHE"),			# Mapuche
...
# MacAurther TODO: Flush this out
barbarians = [
	'''Barbarians(-3000, -850, {iPanther: 1}, ((65, 62), (132, 73)), 5, ANIMALS),
	...
	Barbarians(1200, 1500, {iHorseArcher: 1}, ((85, 57), (95, 67)), 10, INVADERS, target_area=((80, 59), (95, 70)), adjective="TXT_KEY_ADJECTIVE_TATAR"),
	...
	Barbarians(1200, 1500, {iHorseArcher: 2}, ((92, 53), (112, 65)), 16, NOMADS, target_area=((94, 52), (107, 60)), adjective="TXT_KEY_ADJECTIVE_NOGAI", iAlternativeCiv=iMongols),
	...
	Barbarians(1200, 1500, {iHeavySwordsman: 2}, ((76, 33), (81, 36)), 8, INVADERS, target_area=((78, 35), (81, 40)), adjective="TXT_KEY_ADJECTIVE_FUNJ", promotions=(iDesertAdaptation,)),
	...
	#Barbarians(1500, 1650, {iKeshik: 2}, ((105, 58), (115, 64)), 8, INVADERS, target_area=((117, 46), (129, 59)), adjective="TXT_KEY_ADJECTIVE_OIRAT", iAlternativeCiv=iMongols, promotions=(iDesertAdaptation, iSteppeAdaptation,)),
	...
	#Barbarians(1500, 1750, {iKeshik: 1}, ((85, 57), (95, 67)), 12, NOMADS, target_area=((80, 59), (95, 70)), adjective="TXT_KEY_ADJECTIVE_TATAR", promotions=(iSteppeAdaptation,)),
	...
	Barbarians(1500, 1850, {iCuirassier: 2}, ((92, 57), (109, 64)), 10, NOMADS, target_area=((92, 60), (113, 70)), adjective="TXT_KEY_ADJECTIVE_KAZAKH"),
