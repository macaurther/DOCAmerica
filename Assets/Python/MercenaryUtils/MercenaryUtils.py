...
lPossibleExpeditionaries = (iExplorer,
							iBandeirante,
							iCoureurDesBois,
							iRanger,
							iMilitia2,
...
##			        #Rhye - end
	...
	def getAvailableColonists(self, iPlayer):
		...
		print("TEMP: MercenaryUtils::getAvailableColonists(): iPlayer: " + str(iPlayer))
		print("TEMP: MercenaryUtils::getAvailableColonists(): civ(iPlayer): " + str(civ(iPlayer)))
		print("TEMP: MercenaryUtils::getAvailableColonists(): iAmerica: " + str(iAmerica))
	...
	def addAvailableUnit(self, iUnit, unitDict):
		print("TEMP: MercenaryUtils::addAvailableUnit(): iUnit: " + str(iUnit))
		# Get Unit Info
		...
		print("TEMP: MercenaryUtils::addAvailableUnit(): Added: " + newMercenary.getName())
	...
	def computerPlayerThink(self, iPlayer):
		...
		mercenaryDict = self.getAvailableExpeditionaries(iPlayer)
	...
	def getAvailableUnits(self, iPlayer):
		...
		unitList = lPossibleColonists + lPossibleExpeditionaries
