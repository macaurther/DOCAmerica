...
lNeighbours = [
	...
	(iMississippi, iFrance),
	(iMississippi, iCherokee),
	(iMississippi, iApache),
	(iMississippi, iPueblo),
	(iMuisca, iInca),
	(iMuisca, iChimu),
	(iMuisca, iWari),
	(iMuisca, iArawak),
	...
	(iAztec, iMexico),
	(iAztec, iColombia),
	(iHaudenosaunee, iMississippi),
	(iHaudenosaunee, iLakota),
	(iHaudenosaunee, iCherokee),
	...
	(iSpain, iPortugal),
	(iPortugal, iSpain),
	(iCherokee, iHaudenosaunee),
	(iCherokee, iMississippi),
	(iCherokee, iEngland),
	(iCherokee, iFrance),
	(iCherokee, iSpain),
	(iCherokee, iAmerica),
	...
	(iNetherlands, iFrance),
	(iNetherlands, iEngland),
	(iNetherlands, iNorse),
	(iApache, iPueblo),
	(iApache, iLakota),
	(iApache, iSpain),
...
iHalberdier,	iEagle,			iTercio,		iAntiTank,		iArcher,		iCrossbowman,	iGatlingGun,	iMachineGun,	iSkirmisher,	iHolkan,		
iSlinger,		iLongbowman,	iTarascanArcher,iIrregular,		iCacos,			iGrenadier,		iAlbionLegion,	iMarine,		iHorseArcher,	iSwiftArrow,	
...
iFallout, 		iTaiga, 		iPalmForest,	iCanyon,		iReef,			iScrub,			iStraight,		iStraightIslands,iVolcano,		iTradewindNorthEurope,
iTradewindSouthEurope,iTradewindAfrica,iTradewindSiberia,iTradewindAsia) = range(iNumFeatures)
...
iDogSled : 				[(-5000, 1490), 	[iHomelandSiberia]],
...
iOrthodoxMiss : 		[(1490, iEndDate), 	[iHomelandSiberia]],
iCatholicMiss : 		[(1490, iEndDate), 	[iHomelandSouthEurope]],
iProtestantMiss : 		[(1490, iEndDate), 	[iHomelandNorthEurope]],
}

# Mercenary Schedule
dMercenarySchedule = {
iExplorer : 			[(1490, 1800), 		lHomelands],
...
iArquebusier : 			[(1490, 1600), 		lHomelandsEurope],
...
iCuirassier : 			[(1490, 1750), 		lHomelandsEurope],
iConquistador : 		[(1490, 1750), 		[iHomelandSouthEurope]],
...
iBombard : 				[(1490, 1600), 		lHomelandsEurope],
...
iKayak : 				[(-5000, 1490), 	[iHomelandSiberia]],
iCaravel : 				[(1490, 1600), 		lHomelandsEurope],
iCarrack : 				[(1490, 1650), 		[iHomelandSouthEurope]],
iMerchantman : 			[(1600, 1825), 		lHomelandsEurope],
