...
iCivMaryland :		Techs(column=3),
iCivConnecticut :	Techs(column=3),
iCivRhodeIsland :	Techs(column=3),
iCivNorthCarolina :	Techs(column=3),
iCivSouthCarolina :	Techs(column=3),
iCivNewJersey :		Techs(column=3),
iCivNewYork :		Techs(column=3),
iCivPennsylvania :	Techs(column=3),
iCivDelaware :		Techs(column=3),
iCivGeorgia :		Techs(column=3),
iCivAmerica :		Techs(column=3),
iCivCanada :		Techs(column=3),
